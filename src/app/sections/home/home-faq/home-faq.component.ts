...
export class HomeFaqComponent {
  ...
  faqList = [
    ...
    },
    {
      ...
      answer:
        "<ul><li>Título de propiedad, declaratoria de herederos, poder, DNI de los titulares o apoderados. No tengo el título, ¿no se cuál es?, ¿porque necesito la declaratoria?, <a href='vender'>escribime</a> y te asesoro.</li><br><li>Si querés vender un departamento o PH vamos a necesitar el REGLAMENTO DE COPROPIEDAD</li><br><li>Si tenés PLANOS mejor.</li><br><li>Detalle de los SERVICIOS, IMPUESTOS y EXPENSAS actualizados.</li></ul>",
    },
    {
      question:
        '¿Tengo que preparar mi propiedad para el relevamiento fotográfico?',
      answer:
    ...
    {
      question:
        '¿Por qué elegir un agente matriculado a la hora de comprar una propiedad?',
      answer:
    ...
    {
      question:
        '¿Que gastos tengo que tener en cuenta para comprar o vender una propiedad?',
      answer:
