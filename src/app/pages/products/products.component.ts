...
export class ProductsComponent {
  ...
  ngOnInit() {
    ...
    this.metaTagService.updateTag({
      name: 'description',
      content:
        'Explora nuestro catálogo de propiedades cuidadosamente seleccionadas. Verónica Killian te ofrece las mejores opciones inmobiliarias del mercado para tu elección ideal.',
    })
    this.metaTagService.updateTag({
      name: 'keywords',
      content:
    ...
    this.metaTagService.updateTag({
      property: 'og:title',
      content: 'Catálogo de Propiedades - Verónica Killian Inmobiliaria',
    })
    this.metaTagService.updateTag({
